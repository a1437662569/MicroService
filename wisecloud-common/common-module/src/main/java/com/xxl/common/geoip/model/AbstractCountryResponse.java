...
public abstract class AbstractCountryResponse extends AbstractResponse
{
    ...
    AbstractCountryResponse(Continent continent, Country country, MaxMind maxmind,
                            Country registeredCountry, RepresentedCountry representedCountry,
                            Traits traits)
    {
    ...
    /**
     * @return Registered country record for the requested IP address. This record represents the
     *         country where the ISP has registered a given IP block and may differ from the user's
     *         country.
     */
    ...
    /**
     * @return Country record for the requested IP address. This object represents the country
    ...
    /**
     * @return Represented country record for the requested IP address. The represented country is
     *         used for things like military bases. It is only present when the represented country
