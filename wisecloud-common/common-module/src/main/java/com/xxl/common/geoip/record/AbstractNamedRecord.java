...
public abstract class AbstractNamedRecord extends AbstractRecord
{
    ...
    /**
     * @return The GeoName ID for the city. This attribute is returned by all end points.
     */
    ...
    /**
     * @return A {@link Map} from locale codes to the name in that locale. This attribute is
