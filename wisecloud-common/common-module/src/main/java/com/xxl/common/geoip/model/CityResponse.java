...
/**
 * <p> This class provides a model for the data returned by the GeoIP2 Precision: City end point
 * and the GeoIP2 City database. </p> <p> The only difference between the City and Insights model
 * classes is which fields in each record may be populated. </p> <p>
 * 
 * @see <a href="http://dev.maxmind.com/geoip/geoip2/web-services">GeoIP2 Web Services</a> </p>
 */
public final class CityResponse extends AbstractCityResponse
{
    ...
    public CityResponse(@JsonProperty("city") City city,
