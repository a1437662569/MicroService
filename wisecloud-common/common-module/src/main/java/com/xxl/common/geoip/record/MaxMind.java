...
/**
 * <p> Contains data related to your MaxMind account. </p> <p> This record is returned by all the
 * end points. </p>
 */
public final class MaxMind extends AbstractRecord
{
    ...
    /**
     * @return The number of remaining queried in your account for the current end point.
     */
