...
/**
 * <p> This class provides a model for the data returned by the GeoIP2 Precision: Insights end
 * point. </p> <p> The only difference between the City and Insights model classes is which fields
 * in each record may be populated. </p> <p>
 * 
...
public class InsightsResponse extends AbstractCityResponse
{
    ...
    public InsightsResponse(@JsonProperty("city") City city,
