package com.xxl.common.geoip.exception;
...
/**
 * This class represents a non-specific error returned by MaxMind's GeoIP2 web service. This occurs
 * when the web service is up and responding to requests, but the request sent was invalid in some
 * way.
 */
public final class InvalidRequestException extends GeoIp2Exception
{
     ...
     */
    public InvalidRequestException(String message, String code, int httpStatus, URL url,
                                   Throwable e)
    {
        super(message, e);
        this.code = code;
